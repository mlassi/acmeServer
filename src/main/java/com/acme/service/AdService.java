 ...
 */
  ...
  /**
   * Saves or updates the Ad passed in. It will determine whether it's a new entity or existing entity.
   * @param ad
   ...
   * @throws PublishAdException If no ad and/or newspaper was found, the PublishAdException is thrown.
   */
  public Ad postAdToNewspaper(long adId, Newspaper newspaper) throws PublishAdException;

  /**
   * If the ad hasn't been published in the newspaper yet, the cancel will undo the planned
   * publish of the ad and removes the association between the two entities.
   * @param adId
   * @param newspaper
   * @return The persisted ad if both the ad and newspaper exists
   * @throws PublishAdException PublishAdException If no ad and/or newspaper was found, the PublishAdException is thrown.
   */
